...
{
	const char* yTypes[] = {
			"SLOW SPIN", "FAST SPIN", "SPIN_RANDOM", "JITTER", "CASUALJITTER", "RANDOMBACKJITTER", "BACKJITTER", "SIDE", "BACKWARDS", "FORWARDS", "LEFT", "RIGHT", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LUA", "LUA2", "LOWERBODY", "LBYJITTER",  // safe
